...
@NoArgsConstructor
@AllArgsConstructor
public class ReturnFilterRequestDto {
    ...
    private String current_return_ticket_id;
    ...
    public Boolean allNull() {
        if ((from_date_filter == null || from_date_filter.equals("")) &&
                ...
                (current_departure_ticket_id == null || current_departure_ticket_id.equals("")) &&
                (current_return_ticket_id == null || current_return_ticket_id.equals(""))) return true;
        return false;
    }
}
