<template>
    <div>
        <b-card title="Edit Flight Instance" style="max-width: 30rem;" class="ml-auto mr-auto mt-3">

            <b-form @submit.prevent="handleSubmitEditFlightInstance">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmitEditFlightInstance() {
                this.message = ''
                ...
                if (this.dateValidation && this.$route.params.flightInstance_ID) {
                    FlightInstanceService.postUpdateFlightInstance(this.$route.params.flightInstance_ID, this.flightInstance).then(
                        response => {
        ...
        mounted() {
            ...
            this.fetchFlights()
            this.flightInstance.flight_ID = this.$route.params.flight_ID
            this.flightInstance.date = this.$route.params.date
