            ...
            <b-form @submit.prevent="handleSubmitEditUser">
                <b-form-group id="input-group-username" label="Username:" label-for="input-username">
                    <b-form-input id="input-username" v-model="user.username" :state="usernameValidation"
                                  class="form-control" type="text" required placeholder="Enter new username"></b-form-input>
                ...
                <b-form-group id="input-group-password1" label="Password:" label-for="input-password1">
                    <b-form-input id="input-password1" v-model="user.password1" :state="password1Validation"
                                  class="form-control" type="password" required placeholder="Enter new password"></b-form-input>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmitEditUser() {
                this.message = '';
                if (this.usernameValidation && this.password1Validation && this.password2Validation && this.typeValidation && this.$route.params.username) {
                    UserService.postEditUser(this.user, this.$route.params.username).then(
                        response => {
        ...
        mounted() {
            ...
            this.user.password1 = this.$route.params.password1
            this.user.password2 = this.$route.params.password2
