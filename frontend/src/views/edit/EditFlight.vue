<template>
    <div>
        <b-card title="Edit Flight" style="max-width: 30rem;" class="ml-auto mr-auto mt-3">

            <b-form @submit.prevent="handleSubmitEditFlight">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleSubmitEditFlight() {
                this.message = '';
                if (this.idValidation && this.airportsValidation && this.$route.params.ID) {
                    this.flight.id = this.flight.id.toUpperCase()
                    FlightService.postEditFlight(this.flight, this.$route.params.ID).then(
                        response => {
        ...
        mounted() {
            ...
            this.flight.id = this.$route.params.ID
            this.flight.airline = this.$route.params.airline
            this.flight.departure_airport_ID = this.$route.params.departure_airport
            this.flight.arrival_airport_ID = this.$route.params.arrival_airport
        }
    }
</script>
